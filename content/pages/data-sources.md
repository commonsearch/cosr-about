...
Here is an exhaustive list of what we currently use:
 ...
 - **[Web Data Commons Hyperlink Graphs](http://webdatacommons.org/hyperlinkgraph/2012-08/download.html)**: Graphs of all hyperlinks from a 2012 Common Crawl archive. We are currently using their Harmonic Centrality file as a temporary ranking signal on domains. We plan to perform our own analysis of the web graph in the future.
